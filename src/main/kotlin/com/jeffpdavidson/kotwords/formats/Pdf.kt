 ...
 * Inspired by:
 *
 * https://sourceforge.net/projects/puz2pdf
 * https://crosswordnexus.com/js/puz_functions.js
 */
...
private fun PDPageContentStream.showCrossword(page: PDPage, crossword: Crossword) {
    ...
    fun showClueList(clues: Map<Int, String>, header: String) {
        clues.entries.forEachIndexed { index, (clueNumber, clue) ->
            ...
            // Count the number of lines needed for the entire clue, plus the section header if this
            // is the first clue in a section, as we do not want to split a clue apart or show a
            // section header at the end of a column.
